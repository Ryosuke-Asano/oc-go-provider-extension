...
export interface OcGoModelInfo {
  ...
  /** Override the default API base URL for this model (e.g. free Zen models) */
  baseUrl?: string;
}
...
export const OC_GO_MODELS: OcGoModelInfo[] = [
  ...
  // —— Free Zen models (zero-cost tier, uses Zen API endpoint) ——
  {
  ...
  // —— Google Gemini models (OpenAI-compatible API format) ——
  {
    id: "gemini-3.6-flash",
  ...
  // —— OpenAI GPT models (OpenAI-compatible API format) ——
  {
    id: "gpt-5.6-sol",
    name: "GPT 5.6 Sol",
